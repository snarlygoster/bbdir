...
class JosSections(models.Model):
    ...
    class Meta:
        db_table = u'jos__sections'
        verbose_name, verbose_name_plural = "Section", "Sections"
...
class JosContentRating(models.Model):
    ...
    class Meta:
        db_table = u'jos__content_rating'
...
class JosContent(models.Model):
    ...
    cat = models.ForeignKey(JosCategories, db_column='catid')
...
class JosContentFrontpage(models.Model):
    ...
    ordering = models.IntegerField()
    class Meta:
        db_table = u'jos__content_frontpage'
